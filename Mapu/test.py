...
class GoogleMapScraper:
    def __init__(self):
        self.output_file_name = "google_map_business_data1.csv"
        self.headless = False
        self.driver = None
        self.unique_check = []
...
# urls = ["https://www.google.com/maps/search/Nashville+Masonry+contractor/@35.5098836,-87.8700415,8z/data=!3m1!4b1"]
